          ...
          return (
            <button
              ...
              className={[
                ...
                active ? 'border-violet-500/50 ring-2 ring-violet-500/50' : '',
              ].join(' ')}
            >
              ...
              <span
                className={[
                  'absolute top-3 right-3 h-2 w-2 rounded-full bg-violet-500/30',
                  ...
                  <div className="mt-4 flex flex-wrap gap-3">
                    {selected.website && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-2 rounded-xl border border-violet-500/30 bg-white/50 px-3 py-1.5 text-sm font-semibold text-violet-800 shadow-sm backdrop-blur transition hover:border-violet-500/50 hover:bg-white hover:shadow-md focus:ring-2 focus:ring-violet-400/50 focus:outline-none dark:border-violet-400/20 dark:bg-zinc-950/20 dark:text-violet-200"
                      >
                    ...
                    {selected.links?.map((l) => (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-2 rounded-xl border border-zinc-300 bg-white/50 px-3 py-1.5 text-sm font-medium text-zinc-800 shadow-sm backdrop-blur transition hover:bg-white hover:shadow-md focus:ring-2 focus:ring-violet-400/50 focus:outline-none dark:border-white/15 dark:bg-zinc-950/20 dark:text-zinc-200"
                      >
                        {l.label}
                      </a>
                    ))}
