...
export const SPONSORS: Sponsor[] = [
...

  {
    ...
    links: [
      ...
      {
        label: 'LinkedIn',
        href: 'https://www.linkedin.com/company/scoala-gimnaziala-spectrum-constanta/',
      },
    ],
  },

  {
    ...
    links: [{ label: 'Website', href: 'https://delta.cyberm.ca/' }],
  },
...

  {
    ...
    links: [{ label: 'X', href: 'https://x.com/osec_io' }],
  },
  {
    id: 'marinahub',
    name: 'Marina Hub',
